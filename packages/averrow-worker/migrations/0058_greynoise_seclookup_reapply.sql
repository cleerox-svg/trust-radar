-- Migration 0058: Re-apply GreyNoise + SecLookup schema changes
-- Original migration 0056_greynoise_seclookup_c2intel.sql was never applied because
-- it sorts alphabetically before 0056_threat_feeds_c2_tor_drop_et_disposable.sql,
-- which was committed and deployed first. D1 refuses to apply out-of-order migrations.

-- GreyNoise columns on threats table
...
-- SecLookup columns on threats table
