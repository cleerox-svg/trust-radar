...
Averrow's scoring & triage agent doesn't work in the traditional alert pipeline. It receives signals from across the platform — email security posture analysis, threat feed matches, lookalike domain monitoring, social platform scanning, certificate transparency data — and synthesizes them into narratives.
