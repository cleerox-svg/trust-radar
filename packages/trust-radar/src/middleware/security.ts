...
export function applySecurityHeaders(response: Response): Response {
  ...
  headers.set("Content-Security-Policy", [
    ...
    "connect-src 'self' wss: https://lrxradar.com https://api.lrxradar.com https://accounts.google.com https://oauth2.googleapis.com https://*.basemaps.cartocdn.com https://basemaps.cartocdn.com",
