...
INSERT OR IGNORE INTO feed_schedules (id, feed_name, display_name, tier, category, url, interval_mins, parser, requires_key, api_key_env) VALUES
  ...
  ('feed-05', 'sslbl',           'SSL Blocklist (abuse.ch)',   2, 'threat',         'https://sslbl.abuse.ch/blacklist/sslipblacklist.csv',        30, 'csv',  0, NULL),
  ...
  ('feed-16', 'virustotal',      'VirusTotal',                 5, 'threat',         'https://www.virustotal.com/api/v3/',                         0, 'json', 1, 'VIRUSTOTAL_API_KEY'),
  ('feed-17', 'ipqs',            'IPQualityScore',             5, 'reputation',     'https://ipqualityscore.com/api/json/',                       0, 'json', 1, 'IPQS_KEY'),
  ('feed-18', 'certstream',      'CertStream',                 6, 'infrastructure', 'https://certstream.calidog.io/',                             15, 'json', 0, NULL),
