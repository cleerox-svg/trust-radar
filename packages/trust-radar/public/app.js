...
async function render() {
  ...
  if (route.auth) {
    ...
    if (mainEl) mainEl.insertAdjacentHTML('beforeend', '<div style="text-align:center;padding:16px;border-top:1px solid rgba(200,60,60,.15);font-size:10px;color:#4a5a73">Operated by <span style="color:#7a8ba8">LRX Enterprises Inc.</span> <svg width="18" height="12" viewBox="0 0 18 12" style="vertical-align:middle;margin:0 2px"><rect width="4.5" height="12" fill="#C83C3C"/><rect x="4.5" width="9" height="12" fill="#fff"/><rect x="13.5" width="4.5" height="12" fill="#C83C3C"/><path d="M9 2.5l-.6 1.8H6.8l1.3.9-.5 1.6L9 5.9l1.4.9-.5-1.6 1.3-.9H9.6z" fill="#C83C3C"/></svg> Canadian owned and operated</div>');
...
function viewLogin(el) {
  el.innerHTML = `<div class="login-screen">
    ...
    <div style="text-align:center;padding:16px 0 0;font-size:10px;color:var(--text-secondary)">Operated by <span style="color:var(--text-tertiary)">LRX Enterprises Inc.</span> <svg width="18" height="12" viewBox="0 0 18 12" style="vertical-align:middle;margin:0 2px"><rect width="4.5" height="12" fill="#C83C3C"/><rect x="4.5" width="9" height="12" fill="#fff"/><rect x="13.5" width="4.5" height="12" fill="#C83C3C"/><path d="M9 2.5l-.6 1.8H6.8l1.3.9-.5 1.6L9 5.9l1.4.9-.5-1.6 1.3-.9H9.6z" fill="#C83C3C"/></svg> Canadian owned and operated</div>
  </div>`;
}
  ...
  el.innerHTML = `
    ...
    <footer class="pub-footer">
      ...
      <div class="pub-footer-legal">
        <div>\u00A9 2026 LRX Enterprises Inc. <svg width="18" height="12" viewBox="0 0 18 12" style="vertical-align:middle;margin:0 2px"><rect width="4.5" height="12" fill="#C83C3C"/><rect x="4.5" width="9" height="12" fill="#fff"/><rect x="13.5" width="4.5" height="12" fill="#C83C3C"/><path d="M9 2.5l-.6 1.8H6.8l1.3.9-.5 1.6L9 5.9l1.4.9-.5-1.6 1.3-.9H9.6z" fill="#C83C3C"/></svg> Canadian owned and operated</div>
        <div>averrow.com</div>
