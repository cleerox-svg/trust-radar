...
async function render() {
  ...
  if (route.auth) {
    ...
    if (mainEl) mainEl.insertAdjacentHTML('beforeend', '<div style="text-align:center;padding:16px;border-top:1px solid rgba(200,60,60,.15);font-size:10px;color:#4a5a73">Operated by <span style="color:#7a8ba8">LRX Enterprises Inc.</span> 🇨🇦 Canadian owned and operated</div>');
...
function viewLogin(el) {
  el.innerHTML = `<div class="login-screen">
    ...
    <div style="text-align:center;padding:16px 0 0;font-size:10px;color:var(--text-secondary)">Operated by <span style="color:var(--text-tertiary)">LRX Enterprises Inc.</span> 🇨🇦 Canadian owned and operated</div>
  </div>`;
}
  ...
  el.innerHTML = `
    ...
    <footer class="pub-footer">
      ...
      <div class="pub-footer-legal">
        <div>\u00A9 2026 LRX Enterprises Inc. 🇨🇦 Canadian owned and operated</div>
        <div>averrow.com</div>
