...
function viewLogin(el) {
  el.innerHTML = `<div class="login-screen">
    ...
    <div style="text-align:center;padding:16px 0 0;font-size:10px;color:#4a5a73">Operated by <span style="color:#7a8ba8">LRX Enterprises Inc.</span> 🇨🇦 Canadian owned and operated</div>
  </div>`;
}
