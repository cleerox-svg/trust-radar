...
const sections: Section[] = [
  {
    ...
    items: [
      { path: "/dashboard",      label: "Command Center",  icon: <I d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> },
            ...
            {section.items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.badge && (
                    <span className="text-[10px] font-mono px-1.5 py-0.5 rounded shrink-0 bg-cyan-500/15 text-blue-500">
                      {item.badge}
                    </span>
                  )}
                </NavLink>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2 min-w-0">
              <div className="w-7 h-7 rounded-full bg-cyan-500/15 border border-cyan-500/25 flex items-center justify-center shrink-0">
                <span className="text-[11px] font-bold text-blue-500 uppercase">{user.email[0]}</span>
              </div>
