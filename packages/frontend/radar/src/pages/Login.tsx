    ...
    <div className="min-h-screen bg-radar-bg flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm space-y-6">
          <div>
            <h1 className="text-2xl font-bold text-radar-text">Sign in</h1>
            <p className="text-xs text-radar-muted mt-1">Access your signal intelligence dashboard</p>
          </div>
          ...
          <p className="text-center text-xs text-radar-muted">
            No account?{" "}
            <Link to="/register" className="text-radar-cyan hover:underline font-medium">
              Create one
            </Link>
          </p>
        </div>
